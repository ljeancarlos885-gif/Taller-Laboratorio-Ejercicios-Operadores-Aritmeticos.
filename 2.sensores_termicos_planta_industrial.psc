Algoritmo sensores_termicos_planta_industrial
	Definir option,contador Como Entero
	definir sensores,temperatura,temperatura_alta,temperatura_baja,temperatura_maxima,temperatura_minima Como Real
	definir suma_temperaturas,Fahrenheit como real
			...
			1:
				...
				Para contador<-1 Hasta sensores Con Paso 1 Hacer
					Repetir
						...
						Leer temperatura
						Si sensor < temperatura_minima O sensor > temperatura_maxima Entonces
							Escribir "ERROR: La temperatura está fuera del rango permitido. Inténtalo de nuevo."
						FinSi
					Hasta Que temperatura >= temperatura_minima Y sensor <= temperatura_maxima;
